...
Preparing well in advance for the public data release has a major impact on the long-term data and knowledge preservation in the collaboration, and the necessity of starting data preservation when the data is in active use is well motivated by the public data release.
